...
const Experience: FC<ExperienceType> = ({ url, image, company, description, position, startDate, realizations }) => (
  <article className={styles.article}>
    ...
    <section className={styles.position}>
      {position} <span className={styles.duration}>({startDate})</span>
    </section>
